      ...
      <div className="w-full min-h-screen p-2">
        <div className="h-fit w-full bg-slate-50 rounded p-3 shadow-md">
          <h1 className="text-base md:text-lg font-semibold text-gray-700">
            Nahid Ahmed (
            <span className="text-blue-500">{"example@gmail.com"}</span>)
          </h1>
        ...
        <div className="h-fit w-full bg-slate-50 rounded p-3 shadow-md mt-4">
          ...
          <div className="bg-white w-full my-3 border-y px-2 py-3 grid md:grid-cols-2 h-full gap-y-8 md:gap-y-0">
            <div>
              <h1 className="text-sm font-medium text-gray-600 uppercase">
                Account Information
              </h1>
          ...
          <div className="flex items-center justify-end gap-3">
            <button className="text-sm font-medium text-gray-600 px-3  py-1 border rounded-md flex items-center gap-1 hover:shadow-lg duration-200">
