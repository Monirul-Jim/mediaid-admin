            ...
            .then(result => {
                ...
                updateUserProfile(data.name, data.photoURL)
                    .then(() => {
                        ...
                        fetch('https://mediaaid-server.vercel.app/users', {
                            method: 'POST',
                            headers: {
            ...
            <div className="hero login-auth min-h-screen bg-base-200">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    <div className="card dark light flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                        ...
                        <p className="py-2">Already have account ? <Link className='text-blue-800 font-semibold underline' to='/userLogin'>Login</Link></p>
                    </div>
                </div>
            </div>
        </>
